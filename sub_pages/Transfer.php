    ...
    <!----------------------- Deposite Transction Form ------------- -->
        ...
        <div class="container">
            <form method="post" action="" class="row g-3 mt-2">
                <div class="col-md-4">
                    <label for="inputEmail4" class="form-label">Numero da Cota</label>
                    <input type="text" name='account_no' class="form-control" id="inputEmail4" required>
                </div>
                <div class="col-md-4">
                    <label for="inputEmail4" class="form-label">A tranferir para</label>
                ...
                <div class="col-12 text-center">
                    <button type="submit" name="transfer" class="btn btn-primary">Transferir</button>
                </div>
            </form>
        </div>
