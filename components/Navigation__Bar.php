            ...
            <div class="nav__menu">
                <ul class="d-flex">
                    ...
                    ?>
                        ...
                        <li>
                            <a href="https://pruthviraj-rajput-portfolio.rf.gd">Sobre nos</a>
                        </li>
                        <li>
                    ...
                    <?php }else {?>
                        <?php if($_SESSION['ROLE'] == 0){ ?>
                            ...
                            <li>
                                <a href="<?php echo SITE__PATH; ?>/pages/New__Customer.php?type=n">Add Cliente</a>
                            </li>
                            <li>
                                <a href="<?php echo SITE__PATH; ?>/pages/New__Employe.php?type=n">Add Gestor/a</a>
                            </li>
                            <li>
                                <a href="<?php echo SITE__PATH; ?>/pages/Customers.php?type=n">Clientes</a>
                            </li>
                            <li>
                                <a href="<?php echo SITE__PATH; ?>/pages/Employes_Detailes.php?type=n">Gestores</a>
                            </li>
                            <li>
                                <a href="<?php echo SITE__PATH; ?>/pages/All__Transction__History.php?type=n">Transações</a>
                            </li> 
                            <li>
                                <a href="<?php echo SITE__PATH; ?>/pages/Transaction.php?type=n">Transação</a>
                            </li>
                            <li>
                                <a href="<?php echo SITE__PATH; ?>/components/Logout.php">Sair</a>
                            </li>
                        <?php }else{ ?>
                            <li>
                                <a href="<?php echo SITE__PATH; ?>/pages/New__Customer.php?type=n">Add Cliente</a>
