        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-xl-4">
                    <div class="card text-dark bg-light mb-3" style="max-width: 18rem;">
                        <div class="card-body text-center">
                            <h4 class="card-title text-uppercase text-primary">Participantes</h4>
                ...
                <div class="col-xl-4">
                    <div class="card text-dark bg-light mb-3" style="max-width: 18rem;">
                        <div class="card-body text-center">
                            <h4 class="card-title text-uppercase text-primary">Gestores</h4>
                ...
                <div class="col-xl-4">
                    <div class="card text-dark bg-light mb-3" style="max-width: 18rem;">
                        <div class="card-body text-center">
                            <h4 class="card-title text-uppercase text-primary">Saldo do Grupo</h4>
                            <h1 class="card-text text-success"><?php echo  $total['value_sum'];  ?> Mzn</h1>
                        </div>
                    </div>
                </div>
            </div>
