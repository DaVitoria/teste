    ...
    <!-- Display Customer Table -->
        ...
        <div class="container" id="display_record">
            <div class="row text-center">
                <h2>Gestores</h2>
                <p>Todos detalhes dos gestores aqui!</p>
            </div>
                ...
                <table class="table table-striped table-hover table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th width="15%" scope="col">Designação</th>
                            <th width="10%" scope="col">Salário</th>
                            <th width="20%" scope="col">Nome</th>
                            <th width="10%" scope="col">Genero</th>
                            <th width="10%" scope="col">Contrato</th>
                            <th width="20%" scope="col">Acção</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
