    ...
    <!-- Display Customer Table -->
        ...
        <div class="container" id="display_record">
            <div class="row text-center">
                <h2>Participantes</h2>
                <p>Todos detalhes dos Clientes</p>
            </div>
            <div class="table-responsive mt-2">
                <table class="table table-striped table-hover table-bordered">
                    <thead>
                        <tr>
                            <th width="15%" scope="col">Nr da Conta</th>
                            <th width="15%" scope="col">Contacto</th>
                            <th width="10%" scope="col">Saldo da Conta</th>
                            <th width="20%" scope="col">Nome</th>
                            <th width="10%" scope="col">Genero</th>
                            <th width="10%" scope="col">Criação</th>
                            <th width="10%" scope="col">Transação</th>
                            <th width="10%" scope="col">Acção</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php 
                                    ...
                                    ?></td>
                                <td>
                                    <a href="All__Transction__History.php?type=n&id=<?php echo $row['account_no']; ?>"><button class="btn btn-primary">Transações</button></a>
                                </td>
